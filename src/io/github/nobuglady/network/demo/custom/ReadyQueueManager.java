...
import io.github.nobuglady.network.demo.rabbitmq.RabbitMqReceiverReadyQueue;
import io.github.nobuglady.network.demo.rabbitmq.RabbitMqSenderReadyQueue;
...
public class ReadyQueueManager implements IReadyQueue {
	...
	public void shutdown() {
		RabbitMqReceiverReadyQueue.shutdown();
	}
